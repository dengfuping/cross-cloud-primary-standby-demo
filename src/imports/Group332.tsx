...
function Component05Cursor() {
  return (
    <div
      className="absolute inset-[91.22%_9.96%_6.64%_88.83%] hidden"
...
function Alert() {
  return (
    ...
    >
      <div
        aria-hidden="true"
        className="absolute border border-[#79d1b4] border-solid inset-0 pointer-events-none rounded-[4px]"
      />
      <Frame12 />
