...
function Frame4() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] items-center left-[324px] top-[560px]">
      <Icon />
      <Frame9 />
    </div>
  );
...
function Frame12() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-center relative shrink-0">
      <p className="font-['PingFang_SC:Medium',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#191919] text-[14px] text-center text-nowrap tracking-[-0.1504px] whitespace-pre">杭州主实例</p>
    </div>
  );
}
...
function Frame8() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] items-center left-[674px] top-[560px]">
      <Component1 />
      <Frame13 />
    </div>
  );
...
function Group37() {
  return (
    <div className="h-[16px] relative w-[64px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 64 16">
        <g id="Group 288">
          <path d={svgPaths.pb025d00} fill="var(--fill-0, #5189FB)" id="Polygon 2" />
          <rect height="52" id="Rectangle 335" stroke="url(#paint0_linear_7_5909)" strokeWidth="3" transform="rotate(-90 10.5 9.5)" width="3" x="10.5" y="9.5" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_7_5909" x1="47.7569" x2="47.7569" y1="11.2465" y2="64.5965">
  ...
  return (
    <div className="relative size-full">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 16">
        <g id="Group 289">
          <path d={svgPaths.pb025d00} fill="var(--fill-0, #5189FB)" id="Polygon 2" />
          <rect height="11" id="Rectangle 335" stroke="url(#paint0_linear_7_7689)" strokeWidth="3" transform="rotate(-90 11.5 9.5)" width="3" x="11.5" y="9.5" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_7_7689" x1="48.7569" x2="48.7569" y1="11.0628" y2="24.6428">
            <stop stopColor="#5189FB" />
            <stop offset="0.5" stopColor="#D6E4FF" />
            <stop offset="1" stopColor="#5189FB" />
          </linearGradient>
  ...
  return (
    <div className="relative size-full">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 33 16">
        <g id="Group 321">
          <path d={svgPaths.pb025d00} fill="var(--fill-0, #5189FB)" id="Polygon 2" />
          <rect height="20" id="Rectangle 335" stroke="url(#paint0_linear_7_7695)" strokeWidth="3" transform="rotate(-90 11.5 9.5)" width="3" x="11.5" y="9.5" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_7_7695" x1="48.7569" x2="48.7569" y1="11.1031" y2="33.4131">
            <stop stopColor="#5189FB" />
            <stop offset="0.5" stopColor="#D6E4FF" />
            <stop offset="1" stopColor="#5189FB" />
          </linearGradient>
...
function Group39() {
  return (
    <div className="absolute contents left-[442px] top-[571px]">
      <div className="absolute h-[56px] left-[443.6px] top-[571px] w-[52.067px]" data-name="Subtract">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 53 56">
          <path d={svgPaths.p3da56600} fill="var(--fill-0, #E2E8F3)" id="Subtract" />
        </svg>
      </div>
      <p className="absolute font-['PingFang_SC:Medium',sans-serif] inset-[71.69%_47.02%_25.64%_47.02%] leading-[22px] not-italic text-[#191919] text-[14px]">网络连接</p>
    </div>
  );
}
...
function Group40() {
  return (
    <div className="absolute contents left-[578px] top-[571px]">
      <div className="absolute h-[56px] left-[579.6px] top-[571px] w-[52.067px]" data-name="Subtract">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 53 56">
          <path d={svgPaths.p3da56600} fill="var(--fill-0, #E2E8F3)" id="Subtract" />
        </svg>
      </div>
      <p className="absolute font-['PingFang_SC:Medium',sans-serif] inset-[71.69%_32.55%_25.64%_61.49%] leading-[22px] not-italic text-[#191919] text-[14px]">网络连接</p>
    </div>
  );
}
    ...
    <div className="absolute h-[80px] left-[462px] top-[214px] w-[16px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 80">
        <g id="Group 321">
          ...
          <path d="M8 0V71" id="Vector 172" stroke="url(#paint0_linear_7_5913)" strokeWidth="6" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_7_5913" x1="14.4595" x2="14.4595" y1="0.318253" y2="69.1883">
            <stop stopColor="#5189FB" />
            <stop offset="0.5" stopColor="#D6E4FF" />
            <stop offset="1" stopColor="#5189FB" />
          </linearGradient>
    ...
    <div className="h-[108px] relative w-[16px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 108">
        <g id="Group 305">
          ...
          <path d="M8 10L8 98" id="Vector 172" stroke="url(#paint0_linear_7_5900)" strokeWidth="6" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_7_5900" x1="14.4595" x2="14.4595" y1="10.3945" y2="95.7545">
            <stop stopColor="#5189FB" />
            <stop offset="0.5" stopColor="#D6E4FF" />
            <stop offset="1" stopColor="#5189FB" />
          </linearGradient>
    ...
    <div className="h-[108px] relative w-[16px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 108">
        <g id="Group 323">
          ...
          <path d="M8 10L8 98" id="Vector 172" stroke="url(#paint0_linear_7_5895)" strokeWidth="6" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_7_5895" x1="14.4595" x2="14.4595" y1="10.3945" y2="95.7545">
            <stop stopColor="#5189FB" />
            <stop offset="0.5" stopColor="#D6E4FF" />
            <stop offset="1" stopColor="#5189FB" />
          </linearGradient>
...
function Component01Button() {
  return (
    <div className="absolute bg-white box-border content-stretch flex gap-[8px] items-center justify-center left-[790px] px-[16px] py-[9px] rounded-[4px] top-[692px] cursor-pointer hover:bg-[#f5f7fa] transition-colors" data-name="01-按钮Button" data-button-id="vendor-state3-alt-button1">
...
function Component01Button1() {
  return (
    <div className="absolute bg-white box-border content-stretch flex gap-[8px] items-center justify-center left-[320px] px-[16px] py-[9px] rounded-[4px] top-[692px] cursor-pointer hover:bg-[#f5f7fa] transition-colors" data-name="01-按钮Button" data-button-id="vendor-state3-alt-button2">
      <div aria-hidden="true" className="absolute border border-[#cdd5e4] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <p className="font-['PingFang_SC:Regular',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#132039] text-[14px] text-nowrap whitespace-pre">释放实例</p>
    </div>
  );
...
function Component03Comment() {
  return (
    <div className="absolute h-[34px] left-[230px] top-[779px] w-[268px] hidden" data-name="03-comment">
      <div className="absolute h-[34px] left-0 top-0 w-[268px]" data-name="bg">
        <div className="absolute inset-[-1.09%_-0.09%_-0.74%_-0.09%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 269 35">
            <g id="bg">
              <path clipRule="evenodd" d={svgPaths.p2f526b80} fill="var(--fill-0, #FBF7ED)" fillRule="evenodd" />
              <path d={svgPaths.p4c06500} fill="var(--stroke-0, #DFA27D)" />
            </g>
          </svg>
        </div>
      </div>
...
export default function Group45() {
  return (
    <div className="relative size-full">
      <div className="absolute bg-[#f8fafe] h-[404px] left-[24px] rounded-[4px] top-[416px] w-[506px]">
        <div aria-hidden="true" className="absolute border border-[#e2e8f3] border-solid inset-0 pointer-events-none rounded-[4px]" />
      </div>
      <div className="absolute bg-[#f8fafe] h-[404px] left-[546px] rounded-[4px] top-[416px] w-[370px]">
        <div aria-hidden="true" className="absolute border border-[#e2e8f3] border-solid inset-0 pointer-events-none rounded-[4px]" />
      </div>
      <p className="absolute font-['PingFang_SC:Medium',sans-serif] leading-[20px] left-[562px] not-italic text-[#191919] text-[12px] text-nowrap top-[432px] whitespace-pre">云厂商 B</p>
      ...
      <Frame6 />
      <Frame7 />
      <div className="absolute h-[215px] left-[235px] top-[336px] w-[235px]">
        <div className="absolute bottom-0 left-[-1.28%] right-[-1.28%] top-0">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 241 215">
            <path d={svgPaths.pc876900} id="Vector 176" stroke="url(#paint0_linear_7_7699)" strokeWidth="6" />
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_7_7699" x1="229.383" x2="-21.5937" y1="95.9461" y2="78.1893">
                <stop stopColor="#5189FB" />
                <stop offset="0.5" stopColor="#D6E4FF" />
          ...
          <div className="relative size-full">
            <div className="absolute bottom-1/4 left-[8.98%] right-[8.98%] top-[3.12%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 12">
                <path d={svgPaths.p3bdb3b00} fill="var(--fill-0, #5189FB)" id="Polygon 2" />
              </svg>
            </div>
          </div>
        </div>
      </div>
      <div className="absolute flex h-[16px] items-center justify-center left-[506px] top-[591px] w-[64px]">
        <div className="flex-none rotate-[180deg] scale-y-[-100%]">
          <Group37 />
        </div>
      </div>
      <div className="absolute flex h-[16px] items-center justify-center left-[68.3%] right-[29.15%] top-[591px]">
        <div className="flex-none h-[16px] rotate-[180deg] scale-y-[-100%] w-[24px]">
          <Group27 />
        </div>
      </div>
      <div className="absolute flex h-[16px] items-center justify-center left-[16.38%] right-[80.11%] top-[591px]">
        <div className="flex-none h-[16px] scale-y-[-100%] w-[33px]">
          <Group38 />
        </div>
      </div>
      <div className="absolute flex h-[calc(1px*((var(--transform-inner-width)*1)+(var(--transform-inner-height)*0)))] items-center justify-center left-[283px] top-[512px] w-[calc(1px*((var(--transform-inner-height)*1)+(var(--transform-inner-width)*0)))]" style={{ "--transform-inner-width": "87", "--transform-inner-height": "187" } as React.CSSProperties}>
        <div className="flex-none rotate-[90deg] scale-y-[-100%]">
          <div className="h-[187px] relative w-[87px]">
            <div className="absolute bottom-[-1.6%] left-[-3.45%] right-[-3.45%] top-0">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 93 190">
                <path d={svgPaths.p9c77b40} id="Arrow 12" stroke="url(#paint0_linear_7_7693)" strokeWidth="6" />
                <defs>
                  <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_7_7693" x1="106" x2="106" y1="1.2563e-06" y2="187">
                    <stop stopColor="#5189FB" />
                    <stop offset="0.519337" stopColor="#D6E4FF" />
                    <stop offset="1" stopColor="#5189FB" />
                  </linearGradient>
                </defs>
              </svg>
