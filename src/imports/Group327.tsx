import svgPaths from "./svg-xw2vo6fjyr";

/**
 * @figmaAssetKey 01e40526622c475a5ce45aa6763aeee026226e35
 */
function Component({ className }: { className?: string }) {
  return (
    <div className={className} data-name="备实例">
      <div className="absolute bottom-0 left-0 right-0 top-[59.54%]" data-name="路径">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 80 32">
          <path d={svgPaths.p3d7f000} fill="var(--fill-0, #80BDFF)" id="è·¯å¾" />
        </svg>
      </div>
      <div className="absolute bottom-[22.48%] left-0 right-0 top-[59.54%]" data-name="椭圆形">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 80 15">
          <path d={svgPaths.p2093e80} fill="var(--fill-0, #B4D7FF)" id="æ¤­åå½¢" />
        </svg>
      </div>
      <div className="absolute inset-[45.02%_4.19%_25.2%_4.19%]" data-name="路径">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 74 24">
          <path d={svgPaths.pff4a680} fill="var(--fill-0, #1E3861)" id="è·¯å¾" />
        </svg>
      </div>
      <div className="absolute inset-[82.33%_7.93%_8.75%_64.43%]" data-name="编组">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 23 7">
          <g id="ç¼ç»">
            <path d={svgPaths.p4e5d280} fill="var(--fill-0, white)" id="æ¤­åå½¢" />
            <path d={svgPaths.pf500300} fill="var(--fill-0, white)" id="æ¤­åå½¢_2" />
            <path d={svgPaths.p28826700} fill="var(--fill-0, white)" id="æ¤­åå½¢_3" />
          </g>
        </svg>
      </div>
      <div className="absolute bottom-[29.77%] left-0 right-0 top-[29.78%]" data-name="路径">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 80 32">
          <path d={svgPaths.p28705300} fill="var(--fill-0, #80BDFF)" id="è·¯å¾" />
        </svg>
      </div>
      <div className="absolute bottom-[52.24%] left-0 right-0 top-[29.78%]" data-name="椭圆形">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 80 15">
          <path d={svgPaths.p2093e80} fill="var(--fill-0, #B4D7FF)" id="æ¤­åå½¢" />
        </svg>
      </div>
      <div className="absolute inset-[52.55%_7.93%_38.52%_64.43%]" data-name="编组">
        <div className="absolute bottom-[-0.01%] left-0 right-0 top-0">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 23 7">
            <g id="ç¼ç»">
              <path d={svgPaths.p3501a700} fill="var(--fill-0, white)" id="æ¤­åå½¢" />
              <path d={svgPaths.p3c988b40} fill="var(--fill-0, white)" id="æ¤­åå½¢_2" />
              <path d={svgPaths.p6283e80} fill="var(--fill-0, white)" id="æ¤­åå½¢_3" />
            </g>
          </svg>
        </div>
      </div>
      <div className="absolute inset-[15.25%_4.19%_54.98%_4.19%]" data-name="路径">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 74 24">
          <path d={svgPaths.pff4a680} fill="var(--fill-0, #1E3861)" id="è·¯å¾" />
        </svg>
      </div>
      <div className="absolute bottom-[59.55%] left-0 right-0 top-0" data-name="路径">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 80 32">
          <path d={svgPaths.p28705300} fill="var(--fill-0, #80BDFF)" id="è·¯å¾" />
        </svg>
      </div>
      <div className="absolute inset-[22.78%_7.93%_68.29%_64.43%]" data-name="编组">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 23 7">
          <g id="ç¼ç»">
            <path d={svgPaths.p362e3e70} fill="var(--fill-0, white)" id="æ¤­åå½¢" />
            <path d={svgPaths.p3d182580} fill="var(--fill-0, white)" id="æ¤­åå½¢_2" />
            <path d={svgPaths.p28826700} fill="var(--fill-0, white)" id="æ¤­åå½¢_3" />
          </g>
        </svg>
      </div>
      <div className="absolute bottom-[82.02%] left-0 right-0 top-0" data-name="椭圆形">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 80 15">
          <path d={svgPaths.p2093e80} fill="var(--fill-0, #B4D7FF)" id="æ¤­åå½¢" />
        </svg>
      </div>
    ...
    <div className="absolute h-[80px] left-[462px] top-[214px] w-[16px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 80">
        <g id="Group 321">
          ...
          <path d="M8 0V71" id="Vector 172" stroke="url(#paint0_linear_3_739)" strokeWidth="6" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_739" x1="14.4595" x2="14.4595" y1="0.318253" y2="69.1883">
  ...
  return (
    <div className="absolute h-[80px] left-[158px] top-[214px] w-[16px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 80">
        <g id="Group 275">
          <path d={svgPaths.pf5ab500} fill="var(--fill-0, #5189FB)" id="Polygon 2" />
          <path d="M8 0V71" id="Vector 172" stroke="url(#paint0_linear_3_708)" strokeWidth="6" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_708" x1="14.4595" x2="14.4595" y1="0.318253" y2="69.1883">
            <stop stopColor="#5189FB" />
            <stop offset="0.5" stopColor="#D6E4FF" />
            <stop offset="1" stopColor="#5189FB" />
          </linearGradient>
...
function Group24() {
  return (
    <div className="absolute h-[16px] left-[198px] top-[591px] w-[120px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 120 16">
        <g id="Group 267">
          <path d={svgPaths.pb025d00} fill="var(--fill-0, #5189FB)" id="Polygon 2" />
          <rect height="108" id="Rectangle 335" stroke="url(#paint0_linear_3_720)" strokeWidth="3" transform="rotate(-90 10.5 9.5)" width="3" x="10.5" y="9.5" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_720" x1="47.7568" x2="47.7568" y1="11.4976" y2="119.168">
            <stop stopColor="#5189FB" />
            <stop offset="0.5" stopColor="#D6E4FF" />
            <stop offset="1" stopColor="#5189FB" />
          </linearGradient>
...
function Group25() {
  return (
    <div className="h-[16px] relative w-[102px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 102 16">
        <g id="Group 268">
          <path d={svgPaths.pb025d00} fill="var(--fill-0, #5189FB)" id="Polygon 2" />
          <rect height="90" id="Rectangle 335" stroke="url(#paint0_linear_3_632)" strokeWidth="3" transform="rotate(-90 10.5 9.5)" width="3" x="10.5" y="9.5" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_632" x1="47.7569" x2="47.7568" y1="11.4169" y2="101.627">
            <stop stopColor="#5189FB" />
            <stop offset="0.5" stopColor="#D6E4FF" />
            <stop offset="1" stopColor="#5189FB" />
          </linearGradient>
  ...
  return (
    <div className="h-[16px] relative w-[64px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 64 16">
        <g id="Group 288">
          <path d={svgPaths.pb025d00} fill="var(--fill-0, #5189FB)" id="Polygon 2" />
          <rect height="52" id="Rectangle 335" stroke="url(#paint0_linear_3_648)" strokeWidth="3" transform="rotate(-90 10.5 9.5)" width="3" x="10.5" y="9.5" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_648" x1="47.7569" x2="47.7569" y1="11.2465" y2="64.5965">
            <stop stopColor="#5189FB" />
            <stop offset="0.5" stopColor="#D6E4FF" />
            <stop offset="1" stopColor="#5189FB" />
          </linearGradient>
...
function Group31() {
  return (
    <div className="relative size-full">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 62 16">
        <g id="Group 289">
          <path d={svgPaths.pb025d00} fill="var(--fill-0, #5189FB)" id="Polygon 2" />
          <rect height="50" id="Rectangle 335" stroke="url(#paint0_linear_3_704)" strokeWidth="3" transform="rotate(-90 10.5 9.5)" width="3" x="10.5" y="9.5" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_704" x1="47.7569" x2="47.7569" y1="11.2376" y2="62.6476">
            <stop stopColor="#5189FB" />
            <stop offset="0.5" stopColor="#D6E4FF" />
            <stop offset="1" stopColor="#5189FB" />
          </linearGradient>
...
function Component01Button() {
  return (
    <div className="bg-[#f3f6fc] h-[40px] relative rounded-[6px] shrink-0 w-full cursor-not-allowed" data-name="01-按钮Button">
      <div aria-hidden="true" className="absolute border border-[#cdd5e4] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <div className="flex flex-row items-center justify-center size-full">
        <div className="box-border content-stretch flex gap-[8px] h-[40px] items-center justify-center px-[16px] py-[5px] relative w-full">
          <p className="font-['PingFang_SC:Regular',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#c1cbe0] text-[14px] text-nowrap whitespace-pre">切换为主实例</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="h-[108px] relative w-[16px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 108">
        <g id="Group 305">
          ...
          <path d="M8 10L8 98" id="Vector 172" stroke="url(#paint0_linear_3_694)" strokeWidth="6" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_694" x1="14.4595" x2="14.4595" y1="10.3945" y2="95.7545">
            <stop stopColor="#5189FB" />
            <stop offset="0.5" stopColor="#D6E4FF" />
            <stop offset="1" stopColor="#5189FB" />
          </linearGradient>
    ...
    <div className="h-[108px] relative w-[16px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 108">
        <g id="Group 323">
          ...
          <path d="M8 10L8 98" id="Vector 172" stroke="url(#paint0_linear_3_727)" strokeWidth="6" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_727" x1="14.4595" x2="14.4595" y1="10.3945" y2="95.7545">
            <stop stopColor="#5189FB" />
            <stop offset="0.5" stopColor="#D6E4FF" />
            <stop offset="1" stopColor="#5189FB" />
          </linearGradient>
...
function Frame5() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-center relative shrink-0">
      <Component className="h-[78px] relative shrink-0 w-[80px]" />
      <Frame8 />
    </div>
  );
}
...
function Component2() {
  return (
    <div className="[grid-area:1_/_1] bg-[#0181fd] box-border content-stretch flex gap-[10px] h-[40px] items-center justify-center ml-0 mt-0 px-[12px] py-[5px] relative rounded-[4px] w-[116px] cursor-pointer hover:bg-[#0066cc] transition-colors" data-name="1.通用/1.按钮/2.次按钮/3.中号备份 4" data-button-id="state1-button1">
...
function Component3() {
  return (
    <div className="[grid-area:1_/_1] bg-[#0181fd] box-border content-stretch flex gap-[10px] h-[40px] items-center justify-center ml-0 mt-0 px-[12px] py-[5px] relative rounded-[4px] w-[116px] cursor-pointer hover:bg-[#0066cc] transition-colors" data-name="1.通用/1.按钮/2.次按钮/3.中号备份 4" data-button-id="state1-button2">
      <div className="flex flex-col font-['PingFang_SC:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[14px] text-center text-nowrap text-white">
        <p className="leading-[22px] whitespace-pre">切换为主实例</p>
      </div>
    </div>
...
function Frame12() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] items-center left-[776px] top-[560px] w-[116px]">
      <Frame6 />
      <Group22 />
    </div>
  );
...
function Frame() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0">
      <p className="font-['PingFang_SC:Medium',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#0181fd] text-[18px] text-nowrap whitespace-pre">主备切换</p>
    </div>
  );
}
...
function Component26TabZ1() {
  return (
    <div className="content-stretch flex flex-col gap-[15px] items-center relative shrink-0 w-[160px]" data-name="2.框架/6.Tab/Z#/中号/选中（宽度大于32）">
      <p className="font-['PingFang_SC:Medium',sans-serif] leading-[26px] not-italic relative shrink-0 text-[18px] text-[rgba(0,0,0,0.45)] text-nowrap whitespace-pre">容灾切换</p>
...
export default function Group47() {
  return (
    <div className="relative size-full">
      <Group43 />
      <Group44 />
      ...
      <div className="absolute flex h-[16px] items-center justify-center left-[588px] top-[591px] w-[64px]">
        <div className="flex-none rotate-[180deg] scale-y-[-100%]">
          <Group30 />
        </div>
      </div>
      <div className="absolute flex h-[16px] items-center justify-center left-[77.02%] right-[16.38%] top-[591px]">
        <div className="flex-none h-[16px] rotate-[180deg] scale-y-[-100%] w-[62px]">
          <Group31 />
        </div>
      </div>
      <Frame11 />
      <div className="absolute h-[214px] left-[366px] top-[336px] w-[104px]">
        <div className="absolute bottom-0 left-[-2.88%] right-[-2.88%] top-0">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 110 214">
            <path d={svgPaths.p1c3aba00} id="Vector 176" stroke="url(#paint0_linear_3_737)" strokeWidth="6" />
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_737" x1="103.187" x2="-8.32965" y1="95.4999" y2="91.9918">
                <stop stopColor="#5189FB" />
                <stop offset="0.5" stopColor="#D6E4FF" />
