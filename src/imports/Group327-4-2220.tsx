    ...
    <div className="absolute h-[80px] left-[462px] top-[214px] w-[16px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 80">
        <g id="Group 321">
          ...
          <path d="M8 0V71" id="Vector 172" stroke="url(#paint0_linear_4_2272)" strokeWidth="6" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_4_2272" x1="14.4595" x2="14.4595" y1="0.318253" y2="69.1883">
  ...
  return (
    <div className="absolute h-[80px] left-[158px] top-[214px] w-[16px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 80">
        <g id="Group 275">
          <path d={svgPaths.pf5ab500} fill="var(--fill-0, #5189FB)" id="Polygon 2" />
          <path d="M8 0V71" id="Vector 172" stroke="url(#paint0_linear_4_2264)" strokeWidth="6" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_4_2264" x1="14.4595" x2="14.4595" y1="0.318253" y2="69.1883">
            <stop stopColor="#5189FB" />
            <stop offset="0.5" stopColor="#D6E4FF" />
            <stop offset="1" stopColor="#5189FB" />
          </linearGradient>
  ...
  return (
    <div className="h-[16px] relative w-[102px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 102 16">
        <g id="Group 268">
          <path d={svgPaths.pb025d00} fill="var(--fill-0, #5189FB)" id="Polygon 2" />
          <rect height="90" id="Rectangle 335" stroke="url(#paint0_linear_4_2268)" strokeWidth="3" transform="rotate(-90 10.5 9.5)" width="3" x="10.5" y="9.5" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_4_2268" x1="47.7569" x2="47.7568" y1="11.4169" y2="101.627">
            <stop stopColor="#5189FB" />
            <stop offset="0.5" stopColor="#D6E4FF" />
            <stop offset="1" stopColor="#5189FB" />
          </linearGradient>
  ...
  return (
    <div className="h-[16px] relative w-[64px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 64 16">
        <g id="Group 288">
          <path d={svgPaths.pb025d00} fill="var(--fill-0, #5189FB)" id="Polygon 2" />
          <rect height="52" id="Rectangle 335" stroke="url(#paint0_linear_4_2250)" strokeWidth="3" transform="rotate(-90 10.5 9.5)" width="3" x="10.5" y="9.5" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_4_2250" x1="47.7569" x2="47.7569" y1="11.2465" y2="64.5965">
            <stop stopColor="#5189FB" />
            <stop offset="0.5" stopColor="#D6E4FF" />
            <stop offset="1" stopColor="#5189FB" />
          </linearGradient>
  ...
  return (
    <div className="relative size-full">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 62 16">
        <g id="Group 289">
          <path d={svgPaths.pb025d00} fill="var(--fill-0, #5189FB)" id="Polygon 2" />
          <rect height="50" id="Rectangle 335" stroke="url(#paint0_linear_4_2246)" strokeWidth="3" transform="rotate(-90 10.5 9.5)" width="3" x="10.5" y="9.5" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_4_2246" x1="47.7569" x2="47.7569" y1="11.2376" y2="62.6476">
            <stop stopColor="#5189FB" />
            <stop offset="0.5" stopColor="#D6E4FF" />
            <stop offset="1" stopColor="#5189FB" />
          </linearGradient>
    ...
    <div className="h-[108px] relative w-[16px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 108">
        <g id="Group 305">
          ...
          <path d="M8 10L8 98" id="Vector 172" stroke="url(#paint0_linear_4_2254)" strokeWidth="6" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_4_2254" x1="14.4595" x2="14.4595" y1="10.3945" y2="95.7545">
            <stop stopColor="#5189FB" />
            <stop offset="0.5" stopColor="#D6E4FF" />
            <stop offset="1" stopColor="#5189FB" />
          </linearGradient>
    ...
    <div className="h-[108px] relative w-[16px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 108">
        <g id="Group 323">
          ...
          <path d="M8 10L8 98" id="Vector 172" stroke="url(#paint0_linear_4_2259)" strokeWidth="6" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_4_2259" x1="14.4595" x2="14.4595" y1="10.3945" y2="95.7545">
            <stop stopColor="#5189FB" />
            <stop offset="0.5" stopColor="#D6E4FF" />
            <stop offset="1" stopColor="#5189FB" />
          </linearGradient>
...
function Group33() {
  return (
    <div className="absolute left-[524px] top-[571px] w-[52.067px] h-[56px]">
      <div className="absolute h-[56px] left-0 top-0 w-[52.067px]" data-name="Subtract">
...
function Group42() {
  return (
    <div className="absolute left-[660px] top-[571px] w-[52.067px] h-[56px]">
      <div className="absolute h-[56px] left-0 top-0 w-[52.067px]" data-name="Subtract">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 53 56">
  ...
  return (
    <div className="relative size-full">
      ...
      <div className="absolute flex h-[16px] items-center justify-center left-[588px] top-[591px] w-[64px]">
        ...
        <p className="absolute font-['PingFang_SC:Medium',sans-serif] leading-[22px] not-italic text-[#191919] text-[14px] whitespace-nowrap bg-white px-1 left-1/2 -translate-x-1/2">网络连接</p>
      </div>
