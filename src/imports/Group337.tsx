import svgPaths from "./svg-ykv6thkkg6";
...
function Alert() {
  return (
    <div className="absolute bg-[#f5faf8] box-border content-stretch flex gap-[4px] h-[22px] items-center left-[298px] p-[8px] rounded-[4px] top-[522px]" data-name="alert">
      ...
      <div className="flex flex-col font-['PingFang_SC:Regular',sans-serif] justify-end leading-[0] not-italic relative shrink-0 text-[#09593f] text-[12px] text-nowrap">
        <p className="leading-[20px] whitespace-pre">上海地域恢复正常</p>
      </div>
    </div>
  );
}
...
function Component() {
  return (
    <div className="absolute bg-[#0181fd] box-border content-stretch flex gap-[10px] h-[40px] items-center justify-center left-[calc(50%-320px)] px-[12px] py-[5px] rounded-[4px] top-[calc(50%+302px)] translate-x-[-50%] translate-y-[-50%] w-[130px] cursor-pointer hover:bg-[#0066cc] transition-colors" data-name="1.通用/1.按钮/2.次按钮/3.中号备份 4">
...
function Group21() {
  return (
    <div className="absolute contents left-[calc(50%-320px)] top-[calc(50%+302px)] translate-x-[-50%] translate-y-[-50%]">
      <Component />
    </div>
  );
}
...
function Component01Button1() {
  return (
    <div className="absolute bg-white box-border content-stretch flex gap-[8px] items-center justify-center left-[320px] px-[16px] py-[9px] rounded-[4px] top-[692px] cursor-pointer hover:bg-[#f5f7fa] transition-colors" data-name="01-按钮Button">
...
function Component01Button2() {
  return (
    <div className="absolute bg-white box-border content-stretch flex gap-[8px] items-center justify-center left-[790px] px-[16px] py-[9px] rounded-[4px] top-[692px] cursor-pointer hover:bg-[#f5f7fa] transition-colors" data-name="01-按钮Button">
      <div aria-hidden="true" className="absolute border border-[#cdd5e4] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <p className="font-['PingFang_SC:Regular',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#132039] text-[14px] text-nowrap whitespace-pre">释放实例</p>
    </div>
  );
...
function Alert1() {
  return (
    <div className="absolute bg-[#f5faf8] box-border content-stretch flex gap-[4px] h-[22px] items-center left-[766px] p-[8px] rounded-[4px] top-[522px]" data-name="alert">
      <div aria-hidden="true" className="absolute border border-[#79d1b4] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <Frame11 />
      <div className="flex flex-col font-['PingFang_SC:Regular',sans-serif] justify-end leading-[0] not-italic relative shrink-0 text-[#09593f] text-[12px] text-nowrap">
        <p className="leading-[20px] whitespace-pre">上海地域恢复正常</p>
      ...
      <div className="absolute h-[215px] left-[150px] top-[336px] w-[320px]">
        <div className="absolute bottom-0 left-[-0.94%] right-[-0.94%] top-0">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 326 215">
            <path d={svgPaths.p25088400} id="Vector 176" stroke="url(#paint0_linear_7_6832)" strokeWidth="6" />
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_7_6832" x1="311.267" x2="-29.0414" y1="95.9461" y2="63.1603">
                <stop stopColor="#5189FB" />
                <stop offset="0.5" stopColor="#D6E4FF" />
