import svgPaths from "./svg-upayx1ascj";
...
function Component2() {
  return (
    <div className="[grid-area:1_/_1] bg-[#0181fd] box-border content-stretch flex gap-[10px] h-[40px] items-center justify-center ml-0 mt-0 px-[12px] py-[5px] relative rounded-[4px] w-[116px] cursor-pointer hover:bg-[#0066cc] transition-colors" data-name="1.通用/1.按钮/2.次按钮/3.中号备份 4" data-button-id="state2-button1">
...
function Component3() {
  return (
    <div className="[grid-area:1_/_1] bg-[#0181fd] box-border content-stretch flex gap-[10px] h-[40px] items-center justify-center ml-0 mt-0 px-[12px] py-[5px] relative rounded-[4px] w-[116px] cursor-pointer hover:bg-[#0066cc] transition-colors" data-name="1.通用/1.按钮/2.次按钮/3.中号备份 4" data-button-id="state2-button2">
      <div className="flex flex-col font-['PingFang_SC:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[14px] text-center text-nowrap text-white">
        <p className="leading-[22px] whitespace-pre">切换为主实例</p>
      </div>
    </div>
...
function Group24() {
  return (
    <div className="h-[16px] relative w-[120px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 120 16">
        <g id="Group 267">
          <path d={svgPaths.pb025d00} fill="var(--fill-0, #5189FB)" id="Polygon 2" />
          <rect height="108" id="Rectangle 335" stroke="url(#paint0_linear_3_1042)" strokeWidth="3" transform="rotate(-90 10.5 9.5)" width="3" x="10.5" y="9.5" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_1042" x1="47.7568" x2="47.7568" y1="11.4976" y2="73">
            <stop stopColor="#5189FB" />
            <stop offset="0.5" stopColor="#D6E4FF" />
            <stop offset="1" stopColor="#5189FB" />
          </linearGradient>
...
export default function Group46() {
  return (
    <div className="relative size-full">
      ...
      <Frame11 />
      <div className="absolute h-[215px] left-[150px] top-[336px] w-[320px]">
        <div className="absolute bottom-0 left-[-0.94%] right-[-0.94%] top-0">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 326 215">
            <path d={svgPaths.p237fa20} id="Vector 176" stroke="url(#paint0_linear_3_1070)" strokeWidth="6" />
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_1070" x1="311.267" x2="-29.0414" y1="95.9461" y2="63.1603">
                <stop stopColor="#5189FB" />
                <stop offset="0.5" stopColor="#D6E4FF" />
      ...
      <Frame10 />
      <Frame12 />
      <div className="absolute flex h-[calc(1px*((var(--transform-inner-width)*1)+(var(--transform-inner-height)*0)))] items-center justify-center left-[256.34px] top-[512px] w-[calc(1px*((var(--transform-inner-height)*1)+(var(--transform-inner-width)*0)))]" style={{ "--transform-inner-width": "87", "--transform-inner-height": "295.65625" } as React.CSSProperties}>
        <div className="flex-none rotate-[90deg] scale-y-[-100%]">
          <div className="h-[295.657px] relative w-[87px]">
            <div className="absolute bottom-[-1.01%] left-[-3.45%] right-0 top-[-1.01%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 90 302">
                <path d={svgPaths.p8dfc580} id="Arrow 12" stroke="url(#paint0_linear_3_1072)" strokeWidth="6" />
                <defs>
                  <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_1072" x1="106" x2="106" y1="-55.3433" y2="298.657">
                    <stop stopColor="#5189FB" />
      ...
      <div className="absolute flex h-[16px] items-center justify-center left-[198px] top-[591px] w-[120px]">
