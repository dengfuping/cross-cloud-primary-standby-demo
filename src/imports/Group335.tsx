...
function Group32() {
  return (
    <div className="absolute contents left-[138px] top-[733px]">
      ...
      <div
        className="absolute flex h-[calc(1px*((var(--transform-inner-width)*0.9298685193061829)+(var(--transform-inner-height)*0.3678920567035675)))] items-center justify-center left-[146px] top-[733px] w-[calc(1px*((var(--transform-inner-height)*0.9298685193061829)+(var(--transform-inner-width)*0.3678920567035675)))]"
        style={
          {
            "--transform-inner-width": "7",
            "--transform-inner-height": "2",
      ...
      <div
        className="absolute flex h-[calc(1px*((var(--transform-inner-width)*0.9272937178611755)+(var(--transform-inner-height)*0.37433451414108276)))] items-center justify-center left-[157px] top-[735px] w-[calc(1px*((var(--transform-inner-height)*0.9272937178611755)+(var(--transform-inner-width)*0.37433451414108276)))]"
        style={
          {
            "--transform-inner-width": "7",
            "--transform-inner-height": "2",
...
function Group7() {
  return (
    <div
      className="absolute inset-[18.54%_20.44%_75.85%_75.64%]"
      data-name="Group"
    >
      <svg
        className="block size-full"
...
function Alert2() {
  return (
    <div
      className="absolute bg-[#fff2f2] box-border content-stretch flex gap-[4px] h-[22px] items-center left-[401px] p-[8px] rounded-[4px] top-[364px]"
      data-name="alert"
    >
      <div
        aria-hidden="true"
...
export default function Group43() {
  return (
    <div className="relative size-full">
      ...
      <p className="absolute font-['PingFang_SC:Regular',sans-serif] leading-[20px] left-[136px] not-italic text-[#5c6b8a] text-[12px] text-nowrap top-[244px] whitespace-pre">
        业务读请求
      </p>
        ...
        >
          ...
          <defs>
            <radialGradient
              cx="0"
              cy="0"
              gradientTransform="matrix(68 -1.61007e-09 -0.160805 55.3524 68 16)"
              gradientUnits="userSpaceOnUse"
              id="paint0_radial_7_6580"
              r="1"
            >
      ...
      <div className="absolute h-[168.5px] left-[366px] top-[336px] w-[104px]">
        <div className="absolute bottom-0 left-[-2.88%] right-[-2.88%] top-0">
          ...
          >
            <path
              d={svgPaths.p100dd880}
              id="Vector 176"
              stroke="url(#paint0_linear_7_6578)"
              strokeWidth="6"
            />
            <defs>
              <linearGradient
                gradientUnits="userSpaceOnUse"
                id="paint0_linear_7_6578"
                x1="107"
                x2="3"
                y1="84.25"
                y2="84.25"
