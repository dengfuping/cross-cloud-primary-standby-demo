...
function Alert() {
  return (
    <div className="absolute bg-[#fff2f2] box-border content-stretch flex gap-[4px] h-[22px] items-center left-[97px] p-[8px] rounded-[4px] top-[431px]" data-name="alert">
...
function Component03Comment() {
  return (
    <div className="absolute h-[34px] left-[56px] top-[779px] w-[278px] hidden" data-name="03-comment">
      <div className="absolute h-[34px] left-0 top-0 w-[278px]" data-name="bg">
        <div className="absolute inset-[-1.09%_-0.09%_-0.74%_-0.09%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 279 35">
            <g id="bg">
              <path clipRule="evenodd" d={svgPaths.p9b6b80} fill="var(--fill-0, #FBF7ED)" fillRule="evenodd" />
              <path d={svgPaths.p3bed8f00} fill="var(--stroke-0, #DFA27D)" />
            </g>
          </svg>
        </div>
      </div>
      <p className="absolute font-['PingFang_SC:Regular',sans-serif] leading-[20px] left-[8px] not-italic text-[#6e472f] text-[12px] text-nowrap top-[10px] whitespace-pre">停留2秒后云厂商 A 恢复正常，变为页面2.3样式</p>
    </div>
  );
}
