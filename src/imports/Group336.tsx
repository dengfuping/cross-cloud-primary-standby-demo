...
function Component03Comment() {
  return (
    <div className="absolute h-[34px] left-[56px] top-[779px] w-[278px] hidden" data-name="03-comment">
      ...
      <p className="absolute font-['PingFang_SC:Regular',sans-serif] leading-[20px] left-[8px] not-italic text-[#6e472f] text-[12px] text-nowrap top-[10px] whitespace-pre">停留2秒后上海地域恢复正常，变为页面3.3样式</p>
    </div>
  );
}
...
export default function Group40() {
  return (
    <div className="relative size-full">
      ...
      <p className="absolute font-['PingFang_SC:Regular',sans-serif] leading-[20px] left-[127px] not-italic text-[#5c6b8a] text-[12px] text-nowrap top-[244px] whitespace-pre">业务读/写请求</p>
      <Group21 />
