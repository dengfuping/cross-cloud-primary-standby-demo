import svgPaths from "./svg-hcgd2b0lta";
  ...
  return (
    <div className="h-[16px] relative w-[102px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 102 16">
        <g id="Group 268">
          <path d={svgPaths.pb025d00} fill="var(--fill-0, #5189FB)" id="Polygon 2" />
          <rect height="90" id="Rectangle 335" stroke="url(#paint0_linear_6_5036)" strokeWidth="3" transform="rotate(-90 10.5 9.5)" width="3" x="10.5" y="9.5" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_6_5036" x1="47.7569" x2="47.7568" y1="11.4169" y2="101.627">
            <stop stopColor="#5189FB" />
            <stop offset="0.5" stopColor="#D6E4FF" />
            <stop offset="1" stopColor="#5189FB" />
          </linearGradient>
          ...
          <div className="h-[215px] relative w-[364px]">
            <div className="absolute bottom-0 left-[-0.82%] right-[-0.82%] top-0">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 370 215">
                <path d={svgPaths.p13014080} id="Vector 176" stroke="url(#paint0_linear_6_3605)" strokeWidth="6" />
                <defs>
                  <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_6_3605" x1="353.653" x2="-32.4036" y1="95.9461" y2="53.6387">
                    <stop stopColor="#5189FB" />
                    <stop offset="0.5" stopColor="#D6E4FF" />
          ...
          <div className="h-[320.5px] relative w-[87px]">
            <div className="absolute inset-[-0.94%_-0.02%_-0.94%_-3.45%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 91 327">
                <path d={svgPaths.p3e19ff80} id="Arrow 12" stroke="url(#paint0_linear_6_5034)" strokeWidth="6" />
                <defs>
                  <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_6_5034" x1="564.975" x2="564.975" y1="4.43662" y2="315.322">
                    <stop stopColor="#5189FB" />
                    <stop offset="0.5" stopColor="#D6E4FF" />
                    <stop offset="1" stopColor="#5189FB" />
                  </linearGradient>
