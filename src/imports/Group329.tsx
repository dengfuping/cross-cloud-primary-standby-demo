import svgPaths from "./svg-x1w9g6rvku";
    ...
    <div className="h-[16px] relative w-[64px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 64 16">
        <g id="Group 288">
          ...
          <rect height="52" id="Rectangle 335" stroke="url(#paint0_linear_3_1584)" strokeWidth="3" transform="rotate(-90 10.5 9.5)" width="3" x="10.5" y="9.5" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_1584" x1="47.7569" x2="47.7569" y1="11.2465" y2="64.5965">
  ...
  return (
    <div className="relative size-full">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 62 16">
        <g id="Group 289">
          <path d={svgPaths.pb025d00} fill="var(--fill-0, #5189FB)" id="Polygon 2" />
          <rect height="50" id="Rectangle 335" stroke="url(#paint0_linear_3_1590)" strokeWidth="3" transform="rotate(-90 10.5 9.5)" width="3" x="10.5" y="9.5" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_1590" x1="47.7569" x2="47.7569" y1="11.2376" y2="62.6476">
            <stop stopColor="#5189FB" />
            <stop offset="0.5" stopColor="#D6E4FF" />
            <stop offset="1" stopColor="#5189FB" />
          </linearGradient>
...
function Component2() {
  return (
    <div className="[grid-area:1_/_1] bg-[#0181fd] box-border content-stretch flex gap-[10px] h-[40px] items-center justify-center ml-0 mt-0 px-[12px] py-[5px] relative rounded-[4px] w-[116px] cursor-pointer hover:bg-[#0066cc] transition-colors" data-name="1.通用/1.按钮/2.次按钮/3.中号备份 4" data-button-id="state3-button1">
...
function Component3() {
  return (
    <div className="[grid-area:1_/_1] bg-[#0181fd] box-border content-stretch flex gap-[10px] h-[40px] items-center justify-center ml-0 mt-0 px-[12px] py-[5px] relative rounded-[4px] w-[116px] cursor-pointer hover:bg-[#0066cc] transition-colors" data-name="1.通用/1.按钮/2.次按钮/3.中号备份 4" data-button-id="state3-button2">
      <div className="flex flex-col font-['PingFang_SC:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[14px] text-center text-nowrap text-white">
        <p className="leading-[22px] whitespace-pre">切换为主实例</p>
      </div>
    </div>
  ...
  return (
    <div className="h-[16px] relative w-[102px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 102 16">
        <g id="Group 268">
          <path d={svgPaths.pb025d00} fill="var(--fill-0, #5189FB)" id="Polygon 2" />
          <rect height="90" id="Rectangle 335" stroke="url(#paint0_linear_3_1578)" strokeWidth="3" transform="rotate(-90 10.5 9.5)" width="3" x="10.5" y="9.5" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_1578" x1="47.7569" x2="47.7568" y1="11.4169" y2="101.627">
            <stop stopColor="#5189FB" />
            <stop offset="0.5" stopColor="#D6E4FF" />
            <stop offset="1" stopColor="#5189FB" />
          </linearGradient>
...
export default function Group46() {
  return (
    <div className="relative size-full">
      ...
      <div className="absolute aspect-[14/14] flex items-center justify-center left-[15.11%] right-[83.19%] top-[calc(50%+134px)] translate-y-[-50%]">
          ...
          <div className="h-[215px] relative w-[364px]">
            <div className="absolute bottom-0 left-[-0.82%] right-[-0.82%] top-0">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 370 215">
                <path d={svgPaths.p23d78580} id="Vector 176" stroke="url(#paint0_linear_3_1588)" strokeWidth="6" />
                <defs>
                  <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_1588" x1="353.653" x2="-32.4036" y1="95.9461" y2="53.6387">
                    <stop stopColor="#5189FB" />
                    <stop offset="0.5" stopColor="#D6E4FF" />
      ...
      <Frame11 />
      <Frame12 />
      <div className="absolute flex h-[calc(1px*((var(--transform-inner-width)*1)+(var(--transform-inner-height)*0)))] items-center justify-center left-[150px] top-[512px] w-[calc(1px*((var(--transform-inner-height)*1)+(var(--transform-inner-width)*0)))]" style={{ "--transform-inner-width": "87", "--transform-inner-height": "320.5" } as React.CSSProperties}>
        <div className="flex-none rotate-[90deg] scale-y-[-100%]">
          <div className="h-[320.5px] relative w-[87px]">
            <div className="absolute inset-[-0.94%_-0.02%_-0.94%_-3.45%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 91 327">
                <path d={svgPaths.p3e19ff80} id="Arrow 12" stroke="url(#paint0_linear_3_1582)" strokeWidth="6" />
                <defs>
                  <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_1582" x1="564.975" x2="564.975" y1="4.43662" y2="315.322">
                    <stop stopColor="#5189FB" />
                    <stop offset="0.5" stopColor="#D6E4FF" />
                    <stop offset="1" stopColor="#5189FB" />
                  </linearGradient>
