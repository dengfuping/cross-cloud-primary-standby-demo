...
export default function PrimaryBackupSwitch({ resetTrigger }: PrimaryBackupSwitchProps) {
  ...
  const handleStateChange = (event: React.MouseEvent) => {
    ...
    console.log("主备切换 - Clicked button:", buttonId, "Current state:", state, "Text:", text);
